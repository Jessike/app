...
const {updateFood} = require('./routes/put-userFood');
const {deleteFood} = require('./routes/delete-userFood');
...
router.put('/user/food/:id', updateFood);
router.delete('/user/food/:id', deleteFood);
